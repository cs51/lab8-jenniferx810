...
let idFNN = add_listener newswire fakeNewsNetwork;;
let idBF = add_listener newswire buzzFake;; 
...
remove_listener newswire idFNN;;
remove_listener newswire idBF;;
...
let idRR = add_listener newswire receive_report ;;
